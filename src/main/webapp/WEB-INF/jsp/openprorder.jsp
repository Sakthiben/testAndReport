...
<div class="btn-group btn-breadcrumb">
    ...
    <a href="#" class="btn btn-info">Open Production Order</a>
</div>
<ul class="nav nav-tabs" role="tablist">
    <li class="active" ><a href="opeprorder">Open Production Order</a></li>
    ...
    <fieldset class="scheduler-border">
			    		...
			    		<form:form method="POST" action="saveopenprorder">
			    			<div class="row">
			    				
			    				<div class="col-xs-3 col-sm-3">
			    					<div class="form-group">
			    					<form:input type="hidden" class="form-control" path="prodId" value="${editOpenprorderList.prodId}"/>
			    					<form:errors path="prorderCode" cssClass="error"/><br/>
           							<form:label path="prorderCode" for="series" cssClass="required">PROrder Code</form:label>
			   							<form:input class="form-control" type="hidden" path="prorderCode" value="${editOpenprorderList.prorderCode}" />
												...
												<c:if test="${!empty productorder}">
												 	<c:forEach items="${productorder}" var="productorder">
														 <c:choose>
															<c:when test="${productorder.prorderCode eq editOpenprorderList.prorderCode}">
																<option value="${productorder.prId}" selected="selected">${editOpenprorderList.prorderCode}</option>
															</c:when>
															<c:otherwise>
			    					 ...
			    					 <div class="form-group">
           							...
           							<form:label path="date" for="date" cssClass="required">Date</form:label>
			    						 <div class="input-group input-append date" id="datePicker">
			   							...
			   							<form:input type="text" class="form-control" path="date" value="${editOpenprorderList.date}" />
			    				...
			    				<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:errors path="itemtoManufacture" cssClass="error"/><br/>
           							<form:label path="itemtoManufacture" for="series" cssClass="required">Item To Manufacture</form:label>
			   							<form:input class="form-control" type="hidden" path="itemtoManufacture" value="${editOpenprorderList.itemtoManufacture}" />
												...
												<c:if test="${!empty productorder}">
												 	<c:forEach items="${productorder}" var="productorder">
														 <c:choose>
															<c:when test="${productorder.itemtoManufacture eq editOpenprorderList.itemtoManufacture}">
																<option value="${productorder.prId}" selected="selected">${editOpenprorderList.itemtoManufacture}</option>
															</c:when>
															<c:otherwise>
			    				...
			    				<div class="col-xs-3 col-sm-3">
			    						...
			    						<form:errors path="toProduce" cssClass="error"/><br/>
			   							...
			   							<form:input class="form-control" path="toProduce" value="${editOpenprorderList.toProduce}" />
			                ...
			                <div class="form-group">
           					...
           					<form:label path="produced" for="produced" cssClass="required">Produced</form:label>
			   							<form:input class="form-control" path="produced" value="${editOpenprorderList.produced}" />
           					...
           					<form:label path="empCompany" for="empCompany" cssClass="required">Company</form:label>
			   							<form:input class="form-control" path="empCompany" value="${editOpenprorderList.empCompany}" />
...
<fieldset class="scheduler-border">
	...
	<div class="boxData">
		<c:if test="${!empty openprorderList}">
        ...
        <thead><tr>
				...
				<tbody>
				 <c:forEach items="${openprorderList}" var="openprord">
					<tr>
						...
						<td><c:out value="${openprord.empCompany}"/></td>
						  ...
						  <td align="center"><a href="editopenprorder?prodId=${openprord.prodId}">Edit</a> | <a href="deleteopenprorder?prodId=${openprord.prodId}">Delete</a></td> 
					   </tr>
				</c:forEach> 
				</tbody>
