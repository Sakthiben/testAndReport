...
<div class="btn-group btn-breadcrumb">
    ...
    <a href="#" class="btn btn-info">Balance Sheet</a>
</div>
<ul class="nav nav-tabs" role="tablist">
    <li ><a href="trialbalance">Trial Balance </a> </li>
    <li class="active"><a href="balancesheet">Balance Sheet</a> </li>
...
<fieldset class="scheduler-border">
			    		...
			    		<form:form method="POST" action="savebalancesheet">
			    			<div class="row">
			    				
			    				<div class="col-xs-3 col-sm-3">
			    					<div class="form-group">
			    					<form:input type="hidden" class="form-control" path="absId" value="${balanceSheetEdit.absId}"/>
			     					 <form:errors path="company" cssClass="error"/><br/>
           			                 <form:label path="company" for="company" cssClass="required">Company</form:label>       
			     					 <form:input class="form-control" path="company" value="${balanceSheetEdit.company}" />
			               ...
			               <form:input class="form-control" type="hidden" path="startYear" value="${balanceSheetEdit.startYear}"/>
			               ...
			               <form:input class="form-control" type="hidden" path="endYear" value="${balanceSheetEdit.endYear}"/>
			    				...
			    				<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" type="hidden" path="periodicity" value="${balanceSheetEdit.periodicity}" />
											...
											<c:if test="${!empty periodicityList}">
												<c:forEach items="${periodicityList}" var="periodicityList">
													<c:choose>
														<c:when test="${balanceSheetEdit.periodicity eq periodicityList}">
			    			...
			    			<div class="row">
			    				...
			    				<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" path="account" value="${balanceSheetEdit.account}" />
			    				...
			    				<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" path="jan" value="${balanceSheetEdit.jan}" />
			    			...
			    			<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" path="feb" value="${balanceSheetEdit.feb}" />
			    		...
			    		<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" path="mar" value="${balanceSheetEdit.mar}" />
			    			...
			    			<div class="row">
			    				<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" path="apr" value="${balanceSheetEdit.apr}" />
			    			...
			    			<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" path="may" value="${balanceSheetEdit.may}" />
			    			...
			    			<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" path="jun" value="${balanceSheetEdit.jun}" />
			    				...
			    				<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" path="jul" value="${balanceSheetEdit.jul}" />
			    			...
			    			<div class="row">
			    				<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" path="aug" value="${balanceSheetEdit.aug}" />
			    			...
			    			<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" path="sep" value="${balanceSheetEdit.sep}" />
			    				...
			    				<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" path="oct" value="${balanceSheetEdit.oct}" />
			    				...
			    				<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" path="nov" value="${balanceSheetEdit.nov}" />
			    			...
			    			<div class="col-xs-3 col-sm-3 ">
			    					...
			    					<form:input class="form-control" path="dece" value="${balanceSheetEdit.dece}" />
	 ...
	 <c:if test="${!empty accountbalanceList}"> 
		<table class="display download" cellspacing="0" width=100%>
        		<thead><tr>
				  ...
				  <tbody>
				<c:forEach items="${accountbalanceList}" var="accbal">
					<tr>
						<td><c:out value="${accbal.absId}"/></td>
						...
						<td align="center"><a href="./editbalancesheet?absId=${accbal.absId}">Edit</a> | <a href="./deletebalancesheet?absId=${accbal.absId}">Delete</a></td>
					</tr>
				</c:forEach>
			</tbody>  
    	</table>
...
<script>
   ...
   $("#periodList").change(function () {
    ...
    var selectedYears = "${balanceSheetEdit.startYear}";
  	...
  	if(selectedYears != null) {
  	 ...
  	 var selectedYears = "${balanceSheetEdit.endYear}";
   	for (i = new Date().getFullYear(); i > 1990; i--) {
