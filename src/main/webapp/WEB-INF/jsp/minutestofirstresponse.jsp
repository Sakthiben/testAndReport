...
<div class="btn-group btn-breadcrumb">
    ...
    <a href="#" class="btn btn-info">Minutes to First Response for Issues</a>
</div>
<div>
<ul class="nav nav-tabs" role="tablist">
    <li><a href="/TestAndReportStudio/Support/supportanalytics?menulink=supportanalytics">Support Analytics</a></li>
    <li class="active"><a href="/TestAndReportStudio/Support/minutestofirstresponse?menulink=supportanalytics">Minutes to First Response for Issues</a> </li>
</ul>
</div>
<br>
</c:if>
...
<fieldset class="scheduler-border">
 <legend class="scheduler-border">Minutes to First Reponse for Issues</legend>
	<div class="boxData">
	<%-- <c:if test="${!empty productbundlelist}"> --%>
		<table id="minutes" class="display download" cellspacing="0" width=100%>
        		<thead><tr>
					<th>ID</th>
					<th>Date</th>
					<th>Minutes to First Response</th>
				</tr></thead>
				<%--  <tbody>
