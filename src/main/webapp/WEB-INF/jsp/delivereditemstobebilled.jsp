...
<div class="btn-group btn-breadcrumb">
    ...
    <a href="#" class="btn btn-info">Delivered Items To Be Billed</a>
</div>
<div>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="active"><a href="/TestAndReportStudio/ToBill/delivereditemstobebilled?menulink=ToBill">Delivered Items To Be Billed</a> </li>
...
<fieldset class="scheduler-border">
 <legend class="scheduler-border">Delivered Items To Be Billed</legend>
	<div class="boxData">
