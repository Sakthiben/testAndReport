...
<div class="btn-group btn-breadcrumb">
    ...
    <a href="#" class="btn btn-info">Territory Target Variance (Item Group-Wise)</a>
</div>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="active"><a href="/TestAndReportStudio/Selling/territorytargetvariance">Territory Target Variance (Item Group-Wise)</a> </li>
...
<fieldset class="scheduler-border">
 	<legend class="scheduler-border">Territory Target Variance Item Group-Wise</legend>
	<div class="boxData">
        ...
        <tr>
		 ...
		 <tbody>
		    <c:forEach items="${ItemStatus}" var="ItemStatuss">
			  <tr>
				<td>${ItemStatuss.itemstId}</td>
				<td></td>
				<td>${ItemStatuss.itemGroup}</td>
				<td><c:out value=""/></td>
				<td><c:out value=""/></td>
				<td><c:out value=""/></td>
				<td><c:out value=""/></td>
