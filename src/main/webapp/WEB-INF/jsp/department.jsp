...
<div class="btn-group btn-breadcrumb">
 ...
 <ul class="nav nav-tabs" role="tablist">
   ...
   <li class="active"><a href="/TestAndReportStudio/EmployeeDetails/department">Department</a></li>
   <li><a href="/TestAndReportStudio/EmployeeDetails/empattendance">Attendance</a></li>
  </ul>
