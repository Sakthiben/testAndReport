...
<div class="btn-group btn-breadcrumb">
    ...
    <a href="#" class="btn btn-info">Purchase Receipt Trend</a>
</div>
<ul class="nav nav-tabs" role="tablist">
 	<li  ><a href="delnotetrend">DeliveryNote Trend</a></li>
    <li class="active"><a href="purecptrend">Purchase Receipt Trend</a></li>
     
     
  </ul>
   <fieldset class="scheduler-border">
			    		<legend class="scheduler-border">Make New Purchase Receipt Trend</legend>
			 			
			 			<div class="formData">
			 			<c:if test="${msg != null}">
			 				<p style="color: #337ab7"><i class="fa fa-check" aria-hidden="true"></i>${msg}</p>
			 			</c:if>
			    		<form:form method="POST" action="savepurecptrend">
			    			<div class="row">
			    				
			    				<div class="col-xs-3 col-sm-3">
			    					<div class="form-group">
			    					<form:input type="hidden" class="form-control" path="putrendId" value="${purecptrendEdit.putrendId}"/>
									<form:errors path="itemCode" cssClass="error"/><br/>
									<form:label path="itemCode" for="series" cssClass="required">Item</form:label> 
			    					
			   							<form:input class="form-control" type="hidden" path="itemCode" value="${purecptrendEdit.itemCode}" />
			   							  <select class="form-control" id="itemCodelist">
												<option value ="Select" selected="Selected"> - Select the Item - </option>
												<c:if test="${!empty itemlist}">
												 	<c:forEach items="${itemlist}" var="itemlist">
														 <c:choose>
															<c:when test="${itemlist.itemCode eq purecptrendEdit.itemCode}">
																<option value="${itemlist.itemId}" selected="selected">${purecptrendEdit.itemCode}</option>
															</c:when>
															<c:otherwise>
			    				...
			    				<div class="col-xs-3 col-sm-3 ">
			    					  <div class="form-group">
										...
										<form:label path="period" for="toProduce" cssClass="required">Period</form:label> 			    					
			   							<form:input class="form-control" type="hidden" path="period" value="${purecptrendEdit.period}" />
											...
											<c:if test="${!empty PurangeList}">
												<c:forEach items="${PurangeList}" var="PurangeList">
													<c:choose>
														<c:when test="${purecptrendEdit.period eq PurangeList}">
			    				...
			    				<div class="col-xs-3 col-sm-3 ">
										...
										<form:label path="basedOn" for="leaveType" cssClass="required">Based on</form:label> 
			   							...
			   							<form:input class="form-control" type="hidden" path="basedOn" value="${purecptrendEdit.basedOn}" />
											...
											<c:if test="${!empty PuTreeList}">
												<c:forEach items="${PuTreeList}" var="PuTreeList">
													<c:choose>
														<c:when test="${purecptrendEdit.basedOn eq PuTreeList}">
			               ...
			               <form:input class="form-control" type="hidden" path="fiscalYear" value="${purecptrendEdit.fiscalYear}"/>
						  ...
						  <form:label path="company" for="toProduce" cssClass="required">Company</form:label>
			   							...
			   							<form:input class="form-control" path="company" value="${purecptrendEdit.company}" />
						  ...
						  <form:label path="janQty" for="toProduce" cssClass="required">JanQty</form:label>
			   							...
			   							<form:input class="form-control" path="janQty" value="${purecptrendEdit.janQty}" />
								...
								<form:label path="janAmt" for="toProduce" cssClass="required">JanAmt</form:label>			    					
			   					<form:input class="form-control" path="janAmt" value="${purecptrendEdit.janAmt}" />
						  ...
						  <form:label path="febQty" for="toProduce" cssClass="required">FebQty</form:label>
			   							...
			   							<form:input class="form-control" path="febQty" value="${purecptrendEdit.febQty}" />
						  ...
						  <form:label path="febAmt" for="toProduce" cssClass="required">FebAmt</form:label>
			   							...
			   							<form:input class="form-control" path="febAmt" value="${purecptrendEdit.febAmt}" />
						  ...
						  <form:label path="marQty" for="toProduce" cssClass="required">MarQty</form:label>
			   							...
			   							<form:input class="form-control" path="marQty" value="${purecptrendEdit.marQty}" />
						  ...
						  <form:label path="marAmt" for="toProduce" cssClass="required">MarAmt</form:label>
			   							...
			   							<form:input class="form-control" path="marAmt" value="${purecptrendEdit.marAmt}" />
								...
								<form:label path="aprQty" for="toProduce" cssClass="required">AprQty</form:label>
			   							...
			   							<form:input class="form-control" path="aprQty" value="${purecptrendEdit.aprQty}" />
			    			...
			    			<div class="row">
								...
								<form:label path="aprAmt" for="toProduce" cssClass="required">AprAmt</form:label>
			   							...
			   							<form:input class="form-control" path="aprAmt" value="${purecptrendEdit.aprAmt}" />
			    				...
			    				<div class="form-group">
								 ...
								 <form:label path="mayQty" for="toProduce" cssClass="required">MayQty</form:label>			    					
			   					<form:input class="form-control" path="mayQty" value="${purecptrendEdit.mayQty}" />
						  ...
						  <form:label path="mayAmt" for="toProduce" cssClass="required">MayAmt</form:label>
			   							...
			   							<form:input class="form-control" path="mayAmt" value="${purecptrendEdit.mayAmt}" />
						  ...
						  <form:label path="junQty" for="toProduce" cssClass="required">JunQty</form:label>
			   							...
			   							<form:input class="form-control" path="junQty" value="${purecptrendEdit.junQty}" />
						  ...
						  <form:label path="junAmt" for="toProduce" cssClass="required">JunAmt</form:label>
			   							...
			   							<form:input class="form-control" path="junAmt" value="${purecptrendEdit.junAmt}" />
			    				...
			    				<div class="form-group">
								 ...
								 <form:label path="julQty" for="toProduce" cssClass="required">JulQty</form:label>
			   							...
			   							<form:input class="form-control" path="julQty" value="${purecptrendEdit.julQty}" />
						  ...
						  <form:label path="julAmt" for="toProduce" cssClass="required">JulAmt</form:label>
			   							...
			   							<form:input class="form-control" path="julAmt" value="${purecptrendEdit.julAmt}" />
						  ...
						  <form:label path="augQty" for="toProduce" cssClass="required">AugQty</form:label>
			   							...
			   							<form:input class="form-control" path="augQty" value="${purecptrendEdit.augQty}" />
						  ...
						  <form:label path="augAmt" for="toProduce" cssClass="required">AugAmt</form:label>
			   							...
			   							<form:input class="form-control" path="augAmt" value="${purecptrendEdit.augAmt}" />
						  ...
						  <form:label path="sepQty" for="toProduce" cssClass="required">SepQty</form:label>
			   							...
			   							<form:input class="form-control" path="sepQty" value="${purecptrendEdit.sepQty}" />
						  ...
						  <form:label path="sepAmt" for="toProduce" cssClass="required">SepAmt</form:label>
			   							...
			   							<form:input class="form-control" path="sepAmt" value="${purecptrendEdit.sepAmt}" />
						  ...
						  <form:label path="octQty" for="toProduce" cssClass="required">OctQty</form:label>
			   							...
			   							<form:input class="form-control" path="octQty" value="${purecptrendEdit.octQty}" />
						  ...
						  <form:label path="octAmt" for="toProduce" cssClass="required">OctAmt</form:label>
			   							...
			   							<form:input class="form-control" path="octAmt" value="${purecptrendEdit.octAmt}" />
						  ...
						  <form:label path="novQty" for="toProduce" cssClass="required">NovQty</form:label>
			   							...
			   							<form:input class="form-control" path="novQty" value="${purecptrendEdit.novQty}" />
						  ...
						  <form:label path="novAmt" for="toProduce" cssClass="required">NovAmt</form:label>
			   							...
			   							<form:input class="form-control" path="novAmt" value="${purecptrendEdit.novAmt}" />
						  ...
						  <form:label path="decQty" for="toProduce" cssClass="required">DecQty</form:label>
			   							...
			   							<form:input class="form-control" path="decQty" value="${purecptrendEdit.decQty}" />
						  ...
						  <form:label path="decAmt" for="toProduce" cssClass="required">DecAmt</form:label>
			   							...
			   							<form:input class="form-control" path="decAmt" value="${purecptrendEdit.decAmt}" />
						  ...
						  <form:label path="totalQty" for="toProduce" cssClass="required">TotalQty</form:label>
			   							...
			   							<form:input class="form-control" path="totalQty" value="${purecptrendEdit.totalQty}" />
						  ...
						  <form:label path="totalAmt" for="toProduce" cssClass="required">TotalAmt</form:label>
			   							...
			   							<form:input class="form-control" path="totalAmt" value="${purecptrendEdit.totalAmt}" />
...
<fieldset class="scheduler-border">
	...
	<div class="boxData">
        ...
        <thead><tr>
				...
				<tbody>
				  <c:forEach items="${purecptList}" var="pordlist">
					<tr>
						<td><c:out value="${pordlist.putrendId}"/></td>
						...
						<td><c:out value="${pordlist.totalAmt}"/></td>
						  ...
						  <td align="center"><a href="editpurecptrend?putrendId=${pordlist.putrendId}">Edit</a> | <a href="deletepurecptrend?putrendId=${pordlist.putrendId}">Delete</a></td> 
					   </tr>
				</c:forEach>  
				</tbody>
...
$(document).ready(function() {
     ...
     var selectedYears = "${purecptrendEdit.fiscalYear}";
