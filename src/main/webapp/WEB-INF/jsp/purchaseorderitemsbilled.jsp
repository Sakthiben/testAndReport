...
<div class="btn-group btn-breadcrumb">
    ...
    <a href="#" class="btn btn-info">Purchase Order Items to be Billed</a>
</div>	
<div>
<ul class="nav nav-tabs" role="tablist">
    ...
    <ul class="dropdown-menu" style="font-size: 12px;">
      ...
      <li><a href="/TestAndReportStudio/Taxes/purchaseregister?menulink=SalesInvoice">Item-Wise Purchase Register</a></li>
      <li class="active"><a href="/TestAndReportStudio/ToBill/purchaseorderitemsbilled?menulink=SalesInvoice">Purchase Order Items to be Billed</a></li>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li class="active"><a href="/TestAndReportStudio/ToBill/purchaseorderitemsbilled?menulink=ToBill">Purchase Order Items To Be Billed</a></li>
...
<fieldset class="scheduler-border">
 <legend class="scheduler-border">Purchased Items To Be Billed</legend>
	<div class="boxData">
