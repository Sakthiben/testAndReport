...
@Entity
@Table(name="delnotetrends001mb")
public class DeliveryNoteTrend001MB implements Serializable{
...
private static final long serialVersionUID = -723583058586873479L;
	...
	@Column(name = "dntrendId")
	private int dntrendId;
	...
	public int getDntrendId() {
		return dntrendId;
	}

	public void setDntrendId(int dntrendId) {
		this.dntrendId = dntrendId;
	}
