...
@Entity
@Table(name="purecpttrend001mb")
public class PURecptTrend001MB implements Serializable{
...
private static final long serialVersionUID = -723583058586873479L;
	...
	@Column(name = "putrendId")
	private int putrendId;
	...
	public int getPutrendId() {
		return putrendId;
	}

	public void setPutrendId(int putrendId) {
		this.putrendId = putrendId;
	}
